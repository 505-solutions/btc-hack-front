...
async def compile_prover(id, shape):
    model_path = os.path.join(id, 'model.onnx')
    compiled_model_path = os.path.join(id, 'model.compiled')
    pk_path = os.path.join(id, 'test.pk')
    vk_path = os.path.join(id, 'test.vk')
    settings_path = os.path.join(id, 'settings.json')
    witness_path = os.path.join(id, 'witness.json')
    data_path = os.path.join(id, 'input.json')
    srs_path = os.path.join(id, 'kzg.srs')
    proof_path = os.path.join(id, 'test.pf')
    cal_path = os.path.join(id, "calibration.json")
